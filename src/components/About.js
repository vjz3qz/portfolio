...
export default function About() {
  return (
    <section id="about">
      ...
      <div className="container mx-auto lg:max-w-screen-md px-10 py-20 grid grid-cols-1 sm:grid-cols-3 gap-4 items-center">
        <div className="flex flex-col items-start sm:mb-16 mb-0 text-center sm:text-left col-span-1 sm:col-span-2">
          <div>
            <div>
              ...
              <p className="font-light mb-8 leading-relaxed text-slate-300">
